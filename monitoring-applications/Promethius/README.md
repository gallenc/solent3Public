...
Download the `prometheus-template.zip` and extract the contents into the directory you wish to run Prometheus in, and navigate to this location in the linux terminal. Run the application in Docker using the command below, and wait for start up to complete.
